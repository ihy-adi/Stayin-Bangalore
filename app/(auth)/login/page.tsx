    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Sign in to your Stayin Bangalore account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-xl text-xs text-gray-500 text-center">
            Demo: <strong>demo@stayin.in</strong> / <strong>user1234</strong>
            <br />
            Admin: <strong>admin@stayin.in</strong> / <strong>admin123</strong>
          </div>
        </div>
      </div>
    </div>
